...
const OpenMap = forwardRef<OpenMapRef, OpenMapProps>(
  ({ x, y, campusMarks, onFeatureSelected }, ref) => {
    ...
    const isInSchool = ([x, y]: number[]) => {
      ...
      return (
        distance([x, y], outterPosition) < outterRadius &&
        distance([x, y], innerPosition) > innerRadius
      );
    };
    ...
    const updateMarkers = () => {
      ...
      const categoriesToShow =
        currentCategory.current === 0 || currentCategory.current === 1
